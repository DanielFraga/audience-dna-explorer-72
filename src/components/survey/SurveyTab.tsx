...
const wordsetData = [{
  ...
  bulletPoints: [{
    label: "🚨",
    content: "Breaking injury updates and lineup changes"
  }, {
    label: "⚡",
    content: "Live odds swings and momentum shifts"
  }, {
    label: "🏆",
    content: "Cup finals, derby matches, and rivalries"
  }, {
    label: "📰",
    content: "Transfer rumors and major news cycles"
  }]
}, {
  ...
  bulletPoints: [{
    label: "🧭",
    content: "Sequential messaging: awareness → education → conversion"
  }, {
    label: "📍",
    content: "Geo/time segmentation around stadiums and match windows"
  }, {
    label: "🤝",
    content: "Coordinate drops with influencer posting schedules"
  }, {
    label: "🔁",
    content: "Retarget engaged viewers with boosted offers"
  }]
}, {
