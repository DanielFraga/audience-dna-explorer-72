...
const GlassCard: React.FC<GlassCardProps> = ({ title, children, className }) => {
  return (
    ...
    >
      <div className="h-11 flex items-center justify-between text-foreground text-base md:text-[17px] font-semibold tracking-tight border-b border-border/60 mb-3">
