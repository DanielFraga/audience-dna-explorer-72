  ...
  return (
    <div className="mt-4 pt-4 border-t border-gray-800 space-y-4">
      ...
      <div className="space-y-1.5">
        ...
        <div className="flex flex-wrap gap-1">
          <span className="px-1.5 py-0.5 bg-gray-800/50 text-gray-300 rounded text-[9px]">Technology</span>
          <span className="px-1.5 py-0.5 bg-gray-800/50 text-gray-300 rounded text-[9px]">Innovation</span>
          <span className="px-1.5 py-0.5 bg-gray-800/50 text-gray-300 rounded text-[9px]">Digital</span>
        </div>
      </div>
      ...
      <div className="space-y-1.5">
        ...
        <div className="space-y-1">
          <div className="flex items-center space-x-1.5">
            ...
            <span className="px-1.5 py-0.5 bg-gray-800/50 text-gray-300 rounded text-[9px]">Emphasize digital</span>
          </div>
          <div className="flex items-center space-x-1.5">
            <span className="text-[9px] text-red-400">Don't:</span>
            <span className="px-1.5 py-0.5 bg-gray-800/50 text-gray-300 rounded text-[9px]">Focus on traditional</span>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-1.5">
        ...
        <div className="flex flex-wrap gap-1">
          <span className="px-1.5 py-0.5 bg-gray-800/50 text-gray-300 rounded text-[9px]">Digital-first</span>
          <span className="px-1.5 py-0.5 bg-gray-800/50 text-gray-300 rounded text-[9px]">Innovation</span>
        </div>
      </div>
    </div>
